...
class TestLightGBMModel:
    def _make_data(self, n=200, d=10):
    ...
    @pytest.mark.asyncio
    async def test_train_predict_evaluate(self):
        ...
        result = await model.train(X_tr, y_tr, X_te, y_te)
